...
**Most important domain challenge:** 体力，光线，声音，信息不足
...
**Observe:** 需要观察父母睡前的喝水量，观察地形，考察地板材质，门轴新旧程度，听父母动静是否还有鼾声，听门轴或者地板踩下时发出时声响是否超出阈值需要终止行动
...
### Environment Data
- 需要观察父母睡前的喝水量，观察地形，考察地板材质，门轴新旧程度，听父母动静是否还有鼾声，听门轴或者地板踩下时发出时声响是否超出阈值需要终止行动
...
**Factors that force a new judgment:** 地板更易响时需要换落脚点或路线，不能只追求精准按键；门轴变旧时需要重新试探速度；父母由熟睡转为检查时应停止搜索、判断路径并躲藏；照明和掩体位置变化会改变安全路线；设备藏点变化要求搜索而非背答案。父母睡前喝水只作为游戏中的起夜倾向线索，不用于确定预测具体时间。
...
**How player actions change the system:** 按下落脚键的时机改变落脚质量与动作音量；调整开门速度改变门轴声；选择路线和掩体改变位置与暴露程度；停下观察让时间经过，并在没有新刺激时给警觉回落的机会；及时接住晃动的物件避免落地声；搜索藏点改变设备是否找到。体力消耗和恢复规则应保持简单、可见。
