...
export const SOUND_LABELS={lockPin:'弹子卡入',lockScrape:'锁芯刮响',parentStep:'脚步',snore:'鼾声',bed:'床板声',doorSoft:'推门声',doorCreak:'门轴声',latch:'门锁声',crash:'花瓶落地',pencilDrop:'文具滚落',metalDrop:'金属碰撞',toy:'玩具声',radio:'收音机',washer:'洗衣机',catMeow:'猫叫',catChirp:'猫叫',parentGiggle:'忍不住的笑声'};
