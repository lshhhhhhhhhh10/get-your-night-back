export const INCIDENTS={
 ...
 'kitchen-search':{name:'叉子',kind:'fork',chance:.65,noise:55,start:'翻找震到餐具格，叉子滑出来了！',success:'接住叉子，轻轻放回餐具格。',failure:'叮啷！叉子掉在瓷砖上。',sound:'metalDrop'},
 'study-search':{name:'铅笔',kind:'pencils',chance:.45,noise:40,start:'翻找时碰到了笔筒！',success:'扶住笔筒，继续轻轻翻找。',failure:'哒哒！笔筒和铅笔滚到地上。',sound:'pencilDrop'},
 'storage-search':{name:'铁盒',kind:'tin',chance:.5,noise:65,start:'柜子里的铁盒滑下来了！',success:'托住铁盒，稳稳放回。',failure:'哐啷！铁盒撞在地上。',sound:'metalDrop'}
};
