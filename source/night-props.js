...
import {LURES} from './night-tools.js';
export function buildNightProps(house,level){
 ...
 for(const item of LURES.filter(l=>l.minLevel<=level)){
  ...
  if(item.kind==='radio'){box(g,.30,.23,.16,'#a38362',0,.115,0);for(let i=0;i<4;i++)box(g,.13,.012,.008,'#463d3f',-.05,.07+i*.04,.084);lamp=box(g,.045,.045,.01,'#cdb481',.095,.16,.085);box(g,.008,.20,.008,'#b5b7aa',.10,.33,0);}
