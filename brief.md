...
维护日期：2026-09-10。当前公开版 v0.14.1，取消走路震动见日志 49，上传及线上核验见日志 50；门轴、机械开锁与掉落动画来源见日志 45–46 及文末对应补充，上传授权与线上核验见日志 47–48。以下索引用于消除旧条款的并列生效；未被替代的领域、学习目标、取物返程和声音因果链继续保留。
